...
class IngredientSetTest {
    ...
    @Test
    void addNameTagGuardTest() {
        ingredientSet = new IngredientSet(containersArrayList);

        assertThrows(IndexOutOfBoundsException.class, () -> {
            ingredientSet.addNameTag(-1, "Baloney");
            ingredientSet.addNameTag(ingredientSet.getSize(), "Baloney");
            ingredientSet.addNameTag(ingredientSet.getSize() + 1, "Baloney");
        });
    }
    ...
    void addNameTagTest() {
        ...
        ingredientSet.addNameTag(0, "Baloney0");
        ingredientSet.addNameTag(1, "Baloney1");
        ingredientSet.addNameTag(2, "Baloney2");

        assertAll(() -> {
           assertEquals("Baloney0", ingredientSet.getIngredient(0).getNameTag());
           assertEquals("Baloney1", ingredientSet.getIngredient(1).getNameTag());
           assertEquals("Baloney2", ingredientSet.getIngredient(2).getNameTag());
        });
    }

    @Test
    void addDescriptorTagGuardTest() {
        ingredientSet = new IngredientSet(containersArrayList);

        assertThrows(IndexOutOfBoundsException.class, () -> {
           ingredientSet.addDescriptorTag(-1, "This should fail");
           ingredientSet.addDescriptorTag(ingredientSet.getSize(), "This should fail");
           ingredientSet.addDescriptorTag(ingredientSet.getSize() + 1, "This should fail");
        });
    }

    @Test
    void addDescriptorTagTest() {
        ingredientSet = new IngredientSet(containersArrayList);

        ingredientSet.addDescriptorTag(0, "I'm just a beef.");
        ingredientSet.addDescriptorTag(1, "I'm just a duck.");
        ingredientSet.addDescriptorTag(2, "I'm just a chicken");

        assertAll(() -> {
            assertEquals("I'm just a beef", ingredientSet.getIngredient(0).getDescriptorTag());
            assertEquals("I'm just a duck", ingredientSet.getIngredient(1).getDescriptorTag());
            assertEquals("I'm just a chicken", ingredientSet.getIngredient(2).getDescriptorTag());
        });
    }

    @Test
    void addNicknameTagGuardTest() {

    }

    @Test
    void addNicknameTagTest() {

    }

    @Test
    void addTagGuardTest() {
    ...
    @Test
    void addTagsGuardTest() {

    }

    @Test
    void addTagsWithArrayTest() {

    }

    @Test
    void addTagsWithListTest() {
